...
import 'schema/tarefa_record.dart';
...
export 'schema/tarefa_record.dart';
...
/// Functions to query TarefaRecords (as a Stream and as a Future).
Future<int> queryTarefaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TarefaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TarefaRecord>> queryTarefaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TarefaRecord.collection,
      TarefaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TarefaRecord>> queryTarefaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
